...
import 'package:pfe_1/features/authentification/controller/singup/client/verifyemail_controller_client.dart';
...
class VerifyEmailClientScreen extends StatelessWidget {
  const VerifyEmailClientScreen({super.key, this.email});

  final String? email;

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(VerifyEmailControllerClient());
    return Scaffold(
      appBar: AppBar(
